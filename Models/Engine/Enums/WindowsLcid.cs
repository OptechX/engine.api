...
{
    public enum WindowsLcid
    {
        [EnumMember(Value = "Arabic ")] Arabic,
        [EnumMember(Value = "Brazilian")] Brazilian,
        [EnumMember(Value = "Bulgarian")] Bulgarian,
        [EnumMember(Value = "Chinese Simplified")] Chinese_Simplified,
        [EnumMember(Value = "Chinese Traditional")] Chinese_Traditional,
        ...
        [EnumMember(Value = "English International")] English_International,
        [EnumMember(Value = "Estonian")] Estonian,
        [EnumMember(Value = "Finnish")] Finnish,
        [EnumMember(Value = "French")] French,
        [EnumMember(Value = "French Canadian")] French_Canadian,
